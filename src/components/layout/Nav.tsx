    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 h-16 relative">
        ...
        <nav className="hidden md:flex items-center justify-center gap-8 absolute left-1/2 -translate-x-1/2">
          ...
          <NavLink to="/docs" className={({ isActive }) => cn('text-[15px] font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6E56CF]', isActive ? 'text-[#6E56CF]' : 'text-[#1A1A1E] hover:text-[#6E56CF]')}>
            Docs
          </NavLink>
